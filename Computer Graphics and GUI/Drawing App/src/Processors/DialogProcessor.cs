...
namespace Draw
{
	...
	public class DialogProcessor : DisplayProcessor
	{
        ...
        public void AddRandomTrapez()
        {
            ...
            TrapecShape rect = new TrapecShape(new Rectangle(x, y, 100, 200));
        ...
        public void AddRandomMercedes()
        {
            Random rnd = new Random();
            int x = rnd.Next(100, 1000);
            int y = rnd.Next(100, 600);

            MercedesShape merce = new MercedesShape(new Rectangle(x, y, 200, 100));
            merce.FillColor = Color.White;
            merce.BorderColor = Color.Black;
            merce.Opacity = 255;
